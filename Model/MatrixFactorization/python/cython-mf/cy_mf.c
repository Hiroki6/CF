...
static PyObject *__pyx_pf_5cy_mf_6fastMF_4predict(struct __pyx_obj_5cy_mf_fastMF *__pyx_v_self, int __pyx_v_user, int __pyx_v_item) {
  ...
  __Pyx_RefNannySetupContext("predict", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_5cy_mf_6fastMF_predict(__pyx_v_self, __pyx_v_user, __pyx_v_item, 1)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
